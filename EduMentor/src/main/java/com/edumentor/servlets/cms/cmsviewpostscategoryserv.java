 ...
 * @author adrian
 */
@WebServlet(name = "cmsviewpostscategoryserv", urlPatterns = {"/cms/cmsviewpostscategoryserv"})
public class cmsviewpostscategoryserv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String path = "/WEB-INF/pages/cms/cmsviewpostscategory.jsp";
