...
/**
 * Servlet to handle the CMS profile page.
 * Retrieves user information and categories to be displayed on the profile page.
 *
 * @author adrian
 */
...
public class cmsprofileserv extends HttpServlet {
     ...
     * sets both the user and category list as request attributes, and forwards the request to the CMS profile page.</p>
     *
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Forward the request to the CMS profile page
    ...
    public String getServletInfo() {
        return "Servlet to handle the CMS profile page";
    }// </editor-fold>
