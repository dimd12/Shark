...
/**
 * Servlet to display the add post page in the CMS.
 * Retrieves user information and categories to be displayed on the add post page.
 *
 * @author adrian
 */
...
public class cmsshowaddpostserv extends HttpServlet {
     ...
     * sets both the user and category list as request attributes, and forwards the request to the add post page.</p>
     *
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Forward the request to the add post page
    ...
    public String getServletInfo() {
        return "Servlet to display the add post page in the CMS";
    }// </editor-fold>
