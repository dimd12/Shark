 ...
 * @author adrian
 */
@WebServlet(name = "cmsviewquestionscategoryserv", urlPatterns = {"/cms/cmsviewquestionscategoryserv"})
public class cmsviewquestionscategoryserv extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String path = "/WEB-INF/pages/cms/cmsviewquestionscategory.jsp";
